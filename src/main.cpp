...
private:
    ...
    void load() override
    {
        ...
        colorVbo = new VBO;
        colorVbo->setData(sizeof(cube_colors), cube_colors);
        ...
        vao = new VAO;
        cubeVbo->bind();
        vao->setAttributePointer(VAOAttribute(program->getAttributeLocation("position"), GL_FLOAT, 3));
        colorVbo->bind();
        vao->setAttributePointer(VAOAttribute(program->getAttributeLocation("color"), GL_FLOAT, 3));
        vao->bind();
    }
